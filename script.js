...
function openGmail() {
  const email = "shanudoshi9606@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Sanskar Doshi Resume.pdf"; // Path to your resume file
  link.download = "Sanskar Doshi Resume.pdf"; // Name for the downloaded file
